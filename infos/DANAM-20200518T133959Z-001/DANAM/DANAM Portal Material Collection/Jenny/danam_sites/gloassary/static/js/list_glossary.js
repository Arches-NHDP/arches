			...
			success: function(data){
				...
				for (i = 0; i < Object.keys(data.results.bindings).length; i++){
					...
					*/
					...
					$("table").append("<tr><td><a href='https://heidicon.ub.uni-heidelberg.de/pool/nhdp/systematik/" + data.results.bindings[i].label.value + 
					"'>" + data.results.bindings[i].label.value + "</a></td><td>" + data.results.bindings[i].altlabel.value + "</td><td>" + 
					...
					+ "<a href='https://heidicon.ub.uni-heidelberg.de/detail/" + data.results.bindings[i].heidicon.value + "' target='_blank'><font color='blue' size='1px'>link to heidICON</font></a>"
