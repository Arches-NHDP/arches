    ...
    */
	...
	if ( assetDeepLink ) {
	    ...
	    if( document.getElementById( "div-image" ) ){
			...
			divImg.innerHTML = "<table width='50%'><tr><td><img src='" + assetDeepLink.thumblink.url + "'></img></td>"
							  + "<td align='right'><a href='" + assetDeepLink.link + "' target='_blank'>enlarge the image</a><br>"
							  + "<a href='https://heidicon.ub.uni-heidelberg.de/detail/" 
							  + assetDeepLink.object._system_object_id + "' target='_blank'>link to heidICON</a></td></tr></table>"; 
